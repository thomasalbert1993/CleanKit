...
///
/// Orthogonal to the interactor's error- and busy-handling chains: a `.failed` here is the error of
/// *this* content's load, and a screen may hold several independent `Loadable` values.
